...
import djf.ui.AboutAppDialogSingleton;
...
public class AppFileController {
    ...
    public void markAsSelected(AppGUI gui){
        cutcopied = true;
        
        gui.updateCutCopy(cutcopied);
    }
    
    public void markAsUnselectd(AppGUI gui){
        cutcopied = false;
...
//		}
    ...
    public void handleAboutRequest(){
        ...
        AboutAppDialogSingleton aboutSingleton = AboutAppDialogSingleton.getSingleton();
        aboutSingleton.init(primaryStage);
        String l0 = "About this app";
        String l1 = "Metro Map Maker";
        String l2 = "Developed by: Richard McKenna & Yousef Khan";
        String l3 = "2017";
        aboutSingleton.show(l0, l1, l2, l3);
    }
