...
public class AppGUI {
    ...
    protected AppWorkspaceComponent fileWorkspaceComponent;
...
//    protected Button changeLanguageButton;
    ...
    public FlowPane getSettingsToolbar(){
...
//        changeLanguageButton.setDisable(false);
    ...
    public void updateCutCopy(boolean cutcopied){
        copyButton.setDisable(!cutcopied);
        cutButton.setDisable(!cutcopied);
    ...
    private void initTopToolbar(AppTemplate app) {
        ...
        newButton = initChildButtonNoIcon(fileToolbar,	"New",	    NEW_TOOLTIP.toString(),	false);
        loadButton = initChildButtonNoIcon(fileToolbar,	"Load",	    LOAD_TOOLTIP.toString(),	false);
        saveButton = initChildButtonNoIcon(fileToolbar,	"Save",	    SAVE_TOOLTIP.toString(),	true);
        saveAsButton = initChildButtonNoIcon(fileToolbar,"Save As", SAVE_AS_TOOLTIP.toString(),	false);
        exportButton = initChildButtonNoIcon(fileToolbar,"Export",  EXPORT_TOOLTIP.toString(),	false);
        undoButton = initChildButtonNoIcon(fileToolbar,"Undo",      UNDO_TOOLTIP.toString(),	false);
        redoButton = initChildButtonNoIcon(fileToolbar,"Redo",      REDO_TOOLTIP.toString(),	false);
...
//        changeLanguageButton = initChildButton(settingsToolbar,             CHANGE_LANG_ICON.toString(),        CHANGE_LANG_TOOLTIP.toString(),     false);
...
//            fileWorkspaceComponent = app.getWorkspaceComponent();
//            copiedItem = fileWorkspaceComponent.nodeCopy();
//        });
//        cutButton.setOnAction(e -> {
//                        fileWorkspaceComponent = app.getWorkspaceComponent();
//
//            copiedItem = fileWorkspaceComponent.nodeCut();
//        });
//        pasteButton.setOnAction(e -> {
//            fileWorkspaceComponent = app.getWorkspaceComponent();
//            fileWorkspaceComponent.nodePaste(copiedItem);
//        });
    ...
    public Button initChildButtonNoIcon(Pane toolbar, String text, String tooltip, boolean disabled) {
        PropertiesManager props = PropertiesManager.getPropertiesManager();
    ...
    public void newMapFromWelcomeDialog(){
        fileController.handleNewRequest();
    }
   ...
   /**
    ...
    private void initSettingsToolbarStyle(){
